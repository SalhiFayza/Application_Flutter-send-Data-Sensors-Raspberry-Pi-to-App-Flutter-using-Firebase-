...
import 'package:assistantapp/PlantsScreen.dart';
import 'package:assistantapp/pro_plant.dart';
import 'package:assistantapp/application1_icons.dart';

class InfoPlants extends StatefulWidget {
  @override
  _ShopScreenState createState() => _ShopScreenState();
}

class _ShopScreenState extends State<InfoPlants>
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => PlantsScreen(plant: plants[index]),
            ),
          );
        },
        child: Stack(
